...
class CompanyRejHistoryAdapter(val data: ArrayList<HistoryDataResponse>, val onClick: OnClickItem) :
    RecyclerView.Adapter<CompanyRejHistoryAdapter.MyViewHolder>(){
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int){
        ...
        holder.binding.titleName.text = historyData.UsernameA
